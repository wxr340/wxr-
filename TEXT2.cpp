...
{
    Mat image01 = imread("C:\\jjjtp\\2.jpg", 1);    //右图
    Mat image02 = imread("C:\\jjjtp\\111.jpg", 1);    //左图
    imshow("p2", image01);
    imshow("p1", image02);
    ...
    featureDetector->compute(image1, keyPoint1, imageDesc1);
    featureDetector->compute(image2, keyPoint2, imageDesc2);
    ...
    waitKey();
    // 【核心修改：确保窗口稳定显示】
   /* imshow("dst", dst); // 窗口命名更清晰
    imwrite("1dst.jpg", dst);
    while (1)
